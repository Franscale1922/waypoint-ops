...
These are not Kelsey. Delete on sight:
...
## Sample Passages (calibration standard)

These are direct quotes. Every article drafted for Waypoint should feel like it came from the same person who wrote these:

 > **On the advisor's role:**
  > *"I use an analogy I made up on a call once and have never stopped using: I am the chauffeur. You own the car."*

   > **On FDD due diligence:**
    > *"Every FDD has a section called Item 19. That's the financial performance representation. But Item 20 is sometimes more important -- it's where the franchisor has to list everyone who has left the system in the last three years. Ask to talk to a franchisee who had a rough first year. Everyone talks to the brand's success stories. The difference matters enormously. If you're buying a system, you're betting on how well it retains owners."*

     > **On candidate readiness:**
      > *"Honestly? You're in a strong position. I've been through a lot of franchise discovery processes, as a franchisor, as a franchisee, and now as an advisor. A score of [X]/100 tells me your capital, motivation, and timing are well-aligned. That doesn't mean every franchise is right for you. It means we can have a real conversation about which ones are."*

       > **On clarifying what you don't want:**
        > *"It helps a lot to know what you do not want. Industries you would not enjoy, work styles that drain you, commitments you cannot make. That clarity shapes everything."*
         ...
         > **On brand tier selection:**
          ...
          - *"Ready to figure out if this is the right move for you? [Book a call ->]"*
          - *"Not sure where to start? That's exactly what we solve. [Talk to us ->]"*
          - *"Most people in your position find it useful to just have the first conversation. [Schedule 30 minutes ->]"*
          - *"No pitch. No pressure. Just the honest answer. [Book a call ->]"*

          ---

          ## Voice Calibration Checklist (use before finalizing any draft)

          Before submitting any article, run it through these questions:

          - [ ] Does the opening sentence lead with value -- not context-setting?
          - [ ] Is there at least one specific number, item reference, or concrete example?
          - [ ] Does it read like it was written for one person, not a general audience?
          - [ ] Is there an original analogy or reframe -- not a borrowed cliche?
          - [ ] Does it feel candid -- like something a friend with expertise would say?
          - [ ] Is the CTA a single, low-pressure action?
          - [ ] Would you cut at least 20% of it and still keep the meaning? (If it passes that test, you're done.)

          ---

          *Sources: waypoint-core-system (GitHub), candidate email templates, process page copy, readiness quiz copy -- all written by Kelsey Stuart.*
          *Populated: March 2026 | Waypoint Franchise Advisors*
